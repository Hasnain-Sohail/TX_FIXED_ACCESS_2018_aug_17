...
public class Problem_Tx_NOKIA_FiberCut extends PTCL_Base_Problem {

	private static final Logger LOG = LoggerFactory.getLogger(Problem_Tx_NOKIA_FiberCut.class);
	...
	public List<String> computeProblemEntity(Alarm a) throws Exception {
		...
		String AEnd = MapperUtils.doMapping(a, "retrieveNokiaAEndFrom");
		String ZEnd = MapperUtils.doMapping(a, "retrieveNokiaZEndTo");
