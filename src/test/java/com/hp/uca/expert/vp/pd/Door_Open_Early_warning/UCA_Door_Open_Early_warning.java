package com.hp.uca.expert.vp.pd.Door_Open_Early_warning;
...
public class UCA_Door_Open_Early_warning extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_Door_Open_Early_warning.class);

	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/Door_Open_Early_warning/";
	private static final String ALARM_1= "Alarm_Door_Open_Early_warning";
	private static final String groupKEY1 = "<p>Problem_Door_Open_Early_warning</p><e>hw_t2000_sys ihvtfs01_ns:.otnm_islamabad_01 managed_element \"70676\" slot \"/rack=55553/shelf=1/slot=11535386\" equipment \"1\"</e>";
	...
	public UCA_Door_Open_Early_warning() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_Door_Open_Early_warning.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_Door_Open_Early_warning.class);
	}
