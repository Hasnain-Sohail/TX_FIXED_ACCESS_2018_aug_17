package com.hp.uca.expert.vp.pd.EW_U31_Temp_Alarm;
...
public class UCA_EW_U31_Temp_Alarm extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_EW_U31_Temp_Alarm.class);
	//TXM1/src/test/resources/com/hp/uca/expert/vp/pd/HW_TXM_Access_Fiber_Cut/Alarm_HW_TXM_Access_Fiber_Cut.xml
	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/EW_U31_Temp_Alarm/";
	private static final String ALARM_1= "Alarm_EW_U31_Temp_Alarm";
	//private static final String ALARM_2= "Alarm_EW_U31_Temp_Alarm2";
	private static final String groupKEY1 = "<p>Problem_EW_U31_Temp_Alarm</p><e>hw_t2000_sys ihvtfs01_ns:.u2000_islamabad_02 managed_element \"7340839\"</e>";
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_EW_U31_Temp_Alarm.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_EW_U31_Temp_Alarm.class);
	}
