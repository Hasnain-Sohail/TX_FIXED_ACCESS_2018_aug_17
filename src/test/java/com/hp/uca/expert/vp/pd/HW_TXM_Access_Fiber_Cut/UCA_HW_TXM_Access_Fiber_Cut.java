package com.hp.uca.expert.vp.pd.HW_TXM_Access_Fiber_Cut;
...
public class UCA_HW_TXM_Access_Fiber_Cut extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_HW_TXM_Access_Fiber_Cut.class);
	//TXM1/src/test/resources/com/hp/uca/expert/vp/pd/HW_TXM_Access_Fiber_Cut/Alarm_HW_TXM_Access_Fiber_Cut.xml
	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/HW_TXM_Access_Fiber_Cut/";
	private static final String ALARM_1= "Alarm_HW_TXM_Access_Fiber_Cut";
	private static final String ALARM_2= "Alarm_HW_TXM_Access_Fiber_Cut2";
	private static final String groupKEY1 = "<p>Problem_HW_TXM_Access_Fiber_Cut</p><e>7344198</e>";
	...
	public UCA_HW_TXM_Access_Fiber_Cut() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_HW_TXM_Access_Fiber_Cut.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_HW_TXM_Access_Fiber_Cut.class);
	}
