package com.hp.uca.expert.vp.pd.Tx_NOKIA_FiberCut;
...
public class UCA_Tx_NOKIA_FiberCut extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_Tx_NOKIA_FiberCut.class);

	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/Tx_NOKIA_FiberCut/";
	private static final String ALARM_1= "Alarm_Tx_NOKIA_FiberCut";
	private static final String groupKEY1 = "<p>Problem_Tx_NOKIA_FiberCut</p><e>hw_t2000_sys ihvtfs01_ns:.otnm_islamabad_01 managed_element \"2445\"</e>";
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_Tx_NOKIA_FiberCut.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_Tx_NOKIA_FiberCut.class);
	}
