package com.hp.uca.expert.vp.pd.U31_Cabinet_Door_Opened;
...
public class UCA_U31_Cabinet_Door_Opened extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_U31_Cabinet_Door_Opened.class);
	//TXM1/src/test/resources/com/hp/uca/expert/vp/pd/HW_TXM_Access_Fiber_Cut/Alarm_HW_TXM_Access_Fiber_Cut.xml
	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/U31_Cabinet_Door_Opened/";
	private static final String ALARM_1= "Alarm_U31_Cabinet_Door_Opened";
	//private static final String ALARM_2= "Alarm_U31_Cabinet_Door_Opened2";
	private static final String groupKEY1 = "<p>Problem_U31_Cabinet_Door_Opened</p><e>hw_t2000_sys ihvtfs01_ns:.u2000_islamabad_02 managed_element \"7340839\"</e>";
	...
	public UCA_U31_Cabinet_Door_Opened() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_U31_Cabinet_Door_Opened.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_U31_Cabinet_Door_Opened.class);
	}
