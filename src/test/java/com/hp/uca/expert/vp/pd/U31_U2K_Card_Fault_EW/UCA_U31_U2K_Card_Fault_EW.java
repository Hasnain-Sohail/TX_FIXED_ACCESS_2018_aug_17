package com.hp.uca.expert.vp.pd.U31_U2K_Card_Fault_EW;
...
public class UCA_U31_U2K_Card_Fault_EW extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_U31_U2K_Card_Fault_EW.class);
	//TXM1/src/test/resources/com/hp/uca/expert/vp/pd/HW_TXM_Access_Fiber_Cut/Alarm_HW_TXM_Access_Fiber_Cut.xml
	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/U31_U2K_Card_Fault_EW/";
	private static final String ALARM_1= "Alarm_U31_U2K_Card_Fault_EW";
	//private static final String ALARM_2= "Alarm_U31_U2K_Card_Fault_EW2";
	private static final String groupKEY1 = "<p>Problem_U31_U2K_Card_Fault_EW</p><e>new_ne_name</e>";
	...
	public UCA_U31_U2K_Card_Fault_EW() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_U31_U2K_Card_Fault_EW.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_U31_U2K_Card_Fault_EW.class);
	}
