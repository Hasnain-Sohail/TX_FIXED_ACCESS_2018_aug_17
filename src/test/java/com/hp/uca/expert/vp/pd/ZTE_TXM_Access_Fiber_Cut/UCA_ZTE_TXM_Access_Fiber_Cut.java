package com.hp.uca.expert.vp.pd.ZTE_TXM_Access_Fiber_Cut;
...
public class UCA_ZTE_TXM_Access_Fiber_Cut extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_ZTE_TXM_Access_Fiber_Cut.class);
	//TXM1/src/test/resources/com/hp/uca/expert/vp/pd/HW_TXM_Access_Fiber_Cut/Alarm_HW_TXM_Access_Fiber_Cut.xml
	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/ZTE_TXM_Access_Fiber_Cut/";
	private static final String ALARM_1= "Alarm_ZTE_TXM_Access_Fiber_Cut";
	private static final String ALARM_2= "Alarm_ZTE_TXM_Access_Fiber_Cut2";
	private static final String groupKEY1 = "<p>Problem_ZTE_TXM_Access_Fiber_Cut</p><e>u31_islamabad_07 ihvtfs01_ns:.e300_rawalpindi_04 managed_element \"47(p)\" ptp</e>";
	...
	public UCA_ZTE_TXM_Access_Fiber_Cut() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_ZTE_TXM_Access_Fiber_Cut.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_ZTE_TXM_Access_Fiber_Cut.class);
	}
